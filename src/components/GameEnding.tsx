    ...
    <div className="h-full w-full flex flex-col justify-center">
      ...
      >
        ...
        <div className="min-h-[70dvh] max-h-[70dvh] flex flex-col justify-around items-center text-center p-8 gap-6">
          {/* 제목 */}
          <div className="w-4/5 flex flex-row justify-center text-center text-gray-100 bg-opacity-70
          bg-gray-900 rounded-xl border border-gray-600/50 shadow-xl p-5">
            <p className="text-2xl font-bold tracking-wider">{genre || "Genre"} Summary</p>
          </div>
      ...
      <div className="my-4 flex flex-row justify-center items-center gap-8">
        <button 
          ...
          onClick={handleHome}
        >
          <p className="text-gray-700 dark:text-white text-lg font-bold tracking-wide relative z-10
          group-hover:scale-105 transition-transform duration-300">HOME</p>
        </button>
        ...
        >
          <p className="text-gray-700 dark:text-white text-lg font-bold tracking-wide relative z-10
          group-hover:scale-105 transition-transform duration-300">HISTORY</p>
        </button>
      </div>
    </div>
  );
